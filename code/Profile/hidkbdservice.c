...
bStatus_t Hid_AddService(void)
{
    ...
    // Mouse input report
    hidRptMap[1].id = hidReportRefMouseIn[0];
    hidRptMap[1].type = hidReportRefMouseIn[1];
    hidRptMap[1].handle = hidAttrTbl[HID_REPORT_MOUSE_IN_IDX].handle;
    hidRptMap[1].cccdHandle = hidAttrTbl[HID_REPORT_MOUSE_IN_CCCD_IDX].handle;
    ...
    hidRptMap[6].handle = hidAttrTbl[HID_REPORT_LED_OUT_IDX].handle;
